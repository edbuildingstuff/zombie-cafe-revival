...
3. *(in progress)* Opaque binary game data. Still pending: `constants.bin.mid`, `enemyCafeData.bin.mid`, `enemyItems.bin.mid`, `enemyLayouts.bin.mid`, `font3.bin.mid`. Done this phase:
